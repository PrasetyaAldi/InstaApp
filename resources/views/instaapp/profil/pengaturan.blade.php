            ...
            <div class="card-body p-3">
               <div class="row">
                  <div class="col-md-2 text-right">
                     ...
                     @else
                        <img class="img-rounded" src="{{ asset('storage/' . \auth::user()->avatar) }}" width="70px" height="70px" alt="User Avatar">
                  ...
                  <div class="col-md-8">
                     ...
                     <div>
                        <input type="file" class="btn-primary form-control font-size-11" name="avatar">
                     </div>
                  </div>
               </div>
               <div class="row mt-3">
